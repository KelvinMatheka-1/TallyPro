        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFFEFD039), FlutterFlowTheme.of(context).info],
              stops: [0.0, 1.0],
                          ...
                          children: [
                                ...
                                onPressed: () async {
                                  ...
                                  if (_model.currentUserProfille
                                    ...
                                    context.pushNamedAuth(
                                        ...
                                        context.mounted);
                                  } else if (_model.currentUserProfille
                                          ?.elementAtOrNull(0)
                                          ?.role ==
                                      'polling_agent') {
                                    context.pushNamedAuth(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(SigninCopyWidget.routeName);
                                },
                                child: RichText(

  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AgentCheckinsRow:
            return AgentCheckinsRow(data);
          case AgentDashboardViewRow:
            return AgentDashboardViewRow(data);
          case CandidatesRow:
            return CandidatesRow(data);
          case ConstituenciesRow:
            return ConstituenciesRow(data);
          case CountiesRow:
            return CountiesRow(data);
          case DisbursementsRow:
            return DisbursementsRow(data);
          case HourlyTurnoutsRow:
            return HourlyTurnoutsRow(data);
          case PollingCentersRow:
            return PollingCentersRow(data);
          case PollingStreamsRow:
            return PollingStreamsRow(data);
          case ProfilesRow:
          ...
          case StatutoryFormsRow:
            return StatutoryFormsRow(data);
          case TalliesRow:
            return TalliesRow(data);
          case VotersRow:
            return VotersRow(data);
          case WarRoomCandidateTotalsViewRow:
            return WarRoomCandidateTotalsViewRow(data);
          case WarRoomStreamResultsViewRow:
            return WarRoomStreamResultsViewRow(data);
          case WardsRow:

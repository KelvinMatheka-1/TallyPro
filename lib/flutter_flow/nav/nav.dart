...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: AgentDashWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AgentDash')
              : AgentDashWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: VoterSearchPageWidget.routeName,
          path: VoterSearchPageWidget.routePath,
          builder: (context, params) => VoterSearchPageWidget(
        ...
        FFRoute(
            name: BackResultsTallyPageWidget.routeName,
            path: BackResultsTallyPageWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'BackResultsTallyPage')
                : NavBarPage(
                    initialPage: 'BackResultsTallyPage',
                    page: BackResultsTallyPageWidget(),
                  )),
        FFRoute(

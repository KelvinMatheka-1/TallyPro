...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFD939);
  late Color tertiary = const Color(0xFFFFD700);
  late Color alternate = const Color(0xFFE2E8F0);
  late Color primaryText = const Color(0xFF151820);
  late Color secondaryText = const Color(0xFF64748B);
  late Color primaryBackground = const Color(0xFFF8FAF8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x3302CA79);
  late Color accent2 = const Color(0x33FFD939);
  late Color accent3 = const Color(0x33FFD700);
  late Color accent4 = const Color(0x33151820);
  late Color success = const Color(0xFF02CA79);
  late Color warning = const Color(0xFFFFD939);
  late Color error = const Color(0xFF151820);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent2 = const Color(0x33FFD939);
  late Color accent3 = const Color(0x33FFD700);
  late Color accent4 = const Color(0x33FFFFFF);
  late Color success = const Color(0xFF02CA79);
  late Color warning = const Color(0xFFFFD939);

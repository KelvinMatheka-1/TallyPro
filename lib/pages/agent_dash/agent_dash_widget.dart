      ...
      builder: (context, snapshot) {
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
            appBar: AppBar(
              backgroundColor: Color(0xFF60CBEE),
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Text(
                                valueOrDefault<String>(
                                  agentDashAgentDashboardViewRow?.agentName,
                                  'agent name',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                20.0, 12.0, 20.0, 12.0),
                            child: FutureBuilder<List<AgentCheckinsRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<AgentCheckinsRow>
                                    containerAgentCheckinsRowList =
                                    snapshot.data!;
                                      ...
                                      children: [
                                        FutureBuilder<List<AgentCheckinsRow>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<AgentCheckinsRow>
                                                listViewAgentCheckinsRowList =
                                                snapshot.data!;

                                            final listViewAgentCheckinsRow =
                                                listViewAgentCheckinsRowList
                                                        .isNotEmpty
                                                    ? listViewAgentCheckinsRowList
                                                        .first
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      if (containerAgentCheckinsRowList
                                                          .isNotEmpty)
                                                        FFButtonWidget(
                                                          onPressed: () {
                                                            print(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              ScaffoldMessenger
                                                                ...
                                                                SnackBar(
                                                                  content: Text(
                                                                    'Location verified and recorded successfully!',
                                                                    style:
                                                                        TextStyle(
                                                                      color: FlutterFlowTheme.of(
                                                                              context)

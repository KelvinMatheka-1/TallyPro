...
/// |  <- Back          RESULTS TALLY & FORM 34A                  |
/// |  Machakos Primary School • Stream 1                         |
/// +-------------------------------------------------------------+
/// |  🗳️ CANDIDATE BALLOT COUNTS                                 |
/// |                                                             |
/// |  ┌───────────────────────────────────────────────────────┐  |
/// |  |  [Photo] Hon.
///
/// Peter Musyoka Mutua (CCMB)              |  |
/// |  |  Votes Count: [  342  ]                               |  |
/// |  └───────────────────────────────────────────────────────┘  |
/// |  ┌───────────────────────────────────────────────────────┐  |
/// |  |  [Photo] Dr. Grace Kavata Nzioka (URP)                |  |
/// |  |  Votes Count: [  215  ]                               |  |
/// |  └───────────────────────────────────────────────────────┘  |
/// |  ┌───────────────────────────────────────────────────────┐  |
/// |  |  [Photo] Eng. David Mwangi Kitili (NCC)               |  |
/// |  |  Votes Count: [   89  ]                               |  |
/// |  └───────────────────────────────────────────────────────┘  |
/// |  ┌───────────────────────────────────────────────────────┐  |
/// |  |  [Photo] Boniface Kaloki Ndambuki (IND)               |  |
/// |  |  Votes Count: [   24  ]                               |  |
/// |  └───────────────────────────────────────────────────────┘  |
/// +-------------------------------------------------------------+
/// |  📋 BALLOT AUDIT STATS                                      |
/// |  Rejected / Spoilt Ballots: [  10  ]                        |
/// |  Disputed Ballots:          [   0  ]                        |
/// +-------------------------------------------------------------+
/// |  📸 FORM 34A STATUTORY DOCUMENT CAPTURE                     |
/// |  ┌───────────────────────────────────────────────────────┐  |
/// |  |  [ 📷 Take / Upload Form 34A Photo ]                  |  |
/// |  |  (Image Preview shows here once taken)                |  |
/// |  └───────────────────────────────────────────────────────┘  |
/// +-------------------------------------------------------------+
    ...
    return FutureBuilder<List<AgentDashboardViewRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AgentDashboardViewRow>
            backResultsTallyPageAgentDashboardViewRowList = snapshot.data!;

        final backResultsTallyPageAgentDashboardViewRow =
            backResultsTallyPageAgentDashboardViewRowList.isNotEmpty
                ? backResultsTallyPageAgentDashboardViewRowList.first
                : null;
                              ...
                              Row(
                                ...
                                children: [
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      context
                                          .pushNamed(AgentDashWidget.routeName);
                                    },
                                  ),
                                  Expanded(
                                    child: Text(
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<List<CandidatesRow>>(
                                      future: CandidatesTable().queryRows(
                                        queryFn: (q) => q.order('ballot_order',
                                            ascending: true),
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                          ...
                                          itemBuilder:
                                            ...
                                            return Padding(
                                              ...
                                              child: CandidateCardWidget(
                                                ...
                                                initials: listViewCandidatesRow
                                                    .photoUrl,
                                                tone:
                                                    FlutterFlowTheme.of(context)
                                                        .secondaryText,
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_uploadedFormUrl =
                                                true);
